...
| Button | commands, links, toggle/dropdown/split actions | pending canonical reference; demo/source verified only |
| ButtonGroup | grouped related buttons | pending canonical reference |
...
| DateField | date entry | pending canonical reference |
...
| NumericField | numeric entry | pending canonical reference |
...
| SelectField | single-choice field | pending canonical reference |
...
| TextField | text/password/textarea-style entry | pending canonical reference; task examples exist |
| TimeField | time entry | pending canonical reference |
