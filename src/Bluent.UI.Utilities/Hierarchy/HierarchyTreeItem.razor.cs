...
public partial class HierarchyTreeItem : ComponentBase, IDisposable
{
    ...
    private IconDefinition Icon => IsRootItem ? TreeBrowser.RootItemIcon : TreeBrowser.ItemIcon;
    private IconDefinition ExpandedIcon => IsRootItem ? TreeBrowser.RootItemExpandedIcon : TreeBrowser.ItemIcon;
    public string? Path
    {
        get
        {
    ...
    private void AddItem(HierarchyTreeItem item) => _subItems.Add(item);
    private void RemoveItem(HierarchyTreeItem item) => _subItems.Remove(item);
